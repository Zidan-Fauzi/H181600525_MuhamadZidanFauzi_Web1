            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-md-8 col-form-label text-md-left">{!! $KategoriArtikel->create_at->format('d/m/Y H:i') !!}</label>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label text-md-right">Update</label>
                        <label class="col-md-8 col-form-label text-md-left">{!! $KategoriArtikel->update_at->format('d/m/Y H:i')!!}</label>
                    </div>
